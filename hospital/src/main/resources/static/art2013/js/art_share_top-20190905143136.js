...
document.writeln(" <style>#bsPanelHolder {height: 0px;overflow: hidden;}a.bshareDiv div.buzzButton,.bshare-custom .bshareDiv{width:48px;overflow:hidden;}</style>");
document.writeln(" <div class=\"sharebox\">");
document.writeln(" <div class=\"bshare-custom\">");
document.writeln(" <span class=\"share_left\">分享到</span>");
document.writeln(" <a href=\"javascript:void(0);\" title=\"分享到新浪微博\" class=\"bshare-sinaminiblog\"></a>");
//document.writeln(" <a href=\"javascript:void(0);\" title=\"分享到微信\" class=\"bshare-weixin\" onclick=\"javascript:bShare.share(event,'weixin');return false;\"></a>");
