	...
	function redirectSearchUrl(){
		...
		if(!(key == "" || key == "输入疾病名、科室或医生名" || key == "输入疾病名、科室或医院名")) {
			...
			var type = $("#type").val();
			var jumpUrl = "/search/redirect/";
			$("#v33_searchForm").attr('action', jumpUrl);
			$("#v33_searchForm").submit();
		}
	}
			...
			if(i == "0") {
				if($.isArray(arrLabTypeList)) {
					$.each(arrLabTypeList, function(idx, element) {
						if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
							labLi += '<li>';
							labLi+='<a href="http://yyk.39.net/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
						}
				...
				if($.isArray(arrLabTypeList)) {
					$.each(arrLabTypeList, function(idx, element) {
						if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
							labLi += '<li>';
							labLi+='<a href="http://yyk.39.net/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
						}
			...
			if(i == "0") {
				if($.isArray(arrDiseaseList)) {
					$.each(arrDiseaseList, function(idx, element) {
						if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
							diseaseLi += '<li>';
							diseaseLi+='<a href="http://yyk.39.net/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
						}
				...
				if($.isArray(arrDiseaseList)) {
					$.each(arrDiseaseList, function(idx, element) {
						if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
							diseaseLi += '<li>';
							diseaseLi+='<a href="http://yyk.39.net/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
						}
			...
			$.post("/search/hospitalByName.jsonp",{name:key},function(data){
				...
				if($.isArray(arrHospitalList)) {
					$.each(arrHospitalList, function(idx, element) {
							hosLi += '<li>';
							hosLi+='<a href="http://yyk.39.net/doctors/' + element.HEX_ID + '/" title="' + element.NAME + '" target="_blank">' + element.NAME + '</a></li>';
							...
							if(i == "0") {
								...
								if($.isArray(arrLabTypeList)) {
									...
									$.each(arrLabTypeList, function(idx, element) {
										if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
											if (areaSpelling == ""){
												labLi+='<li><a href="http://yyk.39.net/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
											}else {
												labLi+='<li><a href="http://yyk.39.net/' + areaSpelling + '/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
											}
								...
								if($.isArray(arrDiseaseList)) {
									...
									$.each(arrDiseaseList, function(idx, element) {
										if (areaSpelling == ""){
											diseaseLi+='<li><a href="http://yyk.39.net/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
										}else {
											diseaseLi+='<li><a href="http://yyk.39.net/' + areaSpelling + '/doctors/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
										}
								...
								if($.isArray(arrDoctorList)) {
									...
									$.each(arrDoctorList, function(idx, element) {
										docLi += '<li>';
										docLi+='<a target="_blank" href="http://yyk.39.net/doctor/' + element.ID + '.html" title="' + element.NAME + '">' + element.NAME + '(' + element.HOSPITAL_NAME + ')</a></li>';
									});
									if(docLi == "") {
								...
								if($.isArray(arrLabTypeList)) {
									...
									$.each(arrLabTypeList, function(idx, element) {
										if(element.SEO_SPELLING != null && element.SEO_SPELLING != "null" && element.SEO_SPELLING != "") {
											if (areaSpelling == ""){
												labLi+='<li><a href="http://yyk.39.net/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
											}else {
												labLi+='<li><a href="http://yyk.39.net/' + areaSpelling + '/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
											}
								...
								if($.isArray(arrDiseaseList)) {
									...
									$.each(arrDiseaseList, function(idx, element) {
										if (areaSpelling == ""){
											diseaseLi+='<li><a href="http://yyk.39.net/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
										}else {
											diseaseLi+='<li><a href="http://yyk.39.net/' + areaSpelling + '/hospitals/' + element.SEO_SPELLING + '/" title="' + element.NAME_CN + '" target="_blank">' + element.NAME_CN + '</a></li>';
										}
								...
								if($.isArray(arrHospitalList)) {
									...
									$.each(arrHospitalList, function(idx, element) {
										hosLi += '<li>';
										hosLi+='<a target="_blank" href="http://yyk.39.net/' + element.ABBREVIATION.AREA_ABBREVIATION +"/"+element.ABBREVIATION.NATURE_ABBREVIATION +"/"+ element.HEX_ID+'.html" title="' + element.NAME + '">' + element.NAME + '</a></li>';
									});
									if(hosLi == "") {
										$("#hospitalCon").attr("style","display:none;");
									}else {
